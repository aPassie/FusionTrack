...
export const dueDateSchema = z.string().trim().optional().refine((val) => {return !val || !isNaN(Date.parse(val))}, {message: "Invalid date format. Please provide a valid date string."})
